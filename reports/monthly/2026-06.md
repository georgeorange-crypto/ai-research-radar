...
- Other Highlights：327 条进入跟踪；高频信号：robotics、nlp、framework、cs.RO、systems、cs.LG、inference、robot。
...
- Learning Methods / Optimization / Representation Learning：295 条进入跟踪；高频信号：nlp、robotics、cs.LG、framework、optimization、stat.ML、gradient、generalization。
...
- Context Compression / Long Context / Memory：86 条进入跟踪；高频信号：nlp、attention、language model、robotics、KV cache、framework、long-context、inference。
...
- Model Distillation / Model Compression / Efficient Training：80 条进入跟踪；高频信号：nlp、distillation、robotics、framework、cs.LG、language model、low-rank、inference。
...
- RL：70 条进入跟踪；高频信号：nlp、reinforcement learning、framework、rl、optimization、robotics、cs.LG、grpo。
...
- Novel Class Discovery / Open-World Learning / OOD / Continual Learning：66 条进入跟踪；高频信号：nlp、robotics、cs.LG、framework、clustering、out-of-distribution、language model、ood。
