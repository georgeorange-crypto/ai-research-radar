...
- 纳入日报：19 份
- 跟踪条目：2206；MUST_READ 30；SKIM 101；ARCHIVE 961
...
## 分方向趋势
- Agent / Reasoning / Inference-time Scaling / Planning：520 条进入跟踪；高频信号：nlp、framework、robotics、reasoning、language model、inference、agentic、cs.LG。
...
- Benchmark / Dataset / Evaluation：341 条进入跟踪；高频信号：benchmark、evaluation、nlp、robotics、dataset、framework、language model、metrics。
...
- CV：283 条进入跟踪；高频信号：nlp、cs.CV、robotics、image、framework、diffusion、video、github。
...
- Other Highlights：241 条进入跟踪；高频信号：robotics、nlp、framework、systems、cs.RO、cs.LG、inference、robot。
...
- NLP：222 条进入跟踪；高频信号：nlp、robotics、cs.CL、language model、framework、cs.LG、inference、evaluation。
...
- Learning Methods / Optimization / Representation Learning：214 条进入跟踪；高频信号：nlp、robotics、cs.LG、framework、stat.ML、optimization、gradient、generalization。
...
- Institutional Updates：92 条进入跟踪；高频信号：openai.com、anthropic.com、deepmind.google、nvidia.com、research.google、microsoft.com、partnership、release。
...
- Context Compression / Long Context / Memory：62 条进入跟踪；高频信号：language model、nlp、attention、KV cache、robotics、RAG、inference、long-context。
...
- Model Distillation / Model Compression / Efficient Training：56 条进入跟踪；高频信号：distillation、nlp、robotics、framework、language model、low-rank、cs.LG、inference。
...
- Model Architecture：48 条进入跟踪；高频信号：architecture、attention、transformer、robotics、nlp、framework、cs.LG、inference。
...
- Novel Class Discovery / Open-World Learning / OOD / Continual Learning：46 条进入跟踪；高频信号：nlp、cs.LG、robotics、clustering、framework、out-of-distribution、ood、github。
...
- GitHub / Open Source Projects：30 条进入跟踪；高频信号：github、github.com、open-source、framework、inference、evaluation、language model、image。
