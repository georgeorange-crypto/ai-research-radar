...
- 纳入日报：30 份
- 跟踪条目：3137；MUST_READ 43；SKIM 148；ARCHIVE 1271
...
- [From Detection to Action: Using LLM Agents for Fault-Tolerant Control](https://arxiv.org/abs/2606.28011v1)（MUST_READ，Agent / Reasoning / Inference-time Scaling / Planning，score 0.97）
...
## 分方向趋势
- Agent / Reasoning / Inference-time Scaling / Planning：742 条进入跟踪；高频信号：nlp、robotics、framework、reasoning、language model、agentic、cs.LG、inference。
...
- Benchmark / Dataset / Evaluation：492 条进入跟踪；高频信号：benchmark、nlp、evaluation、robotics、dataset、framework、language model、metrics。
...
- CV：417 条进入跟踪；高频信号：cs.CV、nlp、robotics、framework、image、diffusion、github、video。
...
- Other Highlights：341 条进入跟踪；高频信号：robotics、nlp、framework、cs.RO、systems、cs.LG、inference、robot。
...
- Learning Methods / Optimization / Representation Learning：315 条进入跟踪；高频信号：nlp、robotics、cs.LG、framework、optimization、stat.ML、gradient、generalization。
...
- NLP：312 条进入跟踪；高频信号：nlp、robotics、cs.CL、language model、framework、cs.LG、inference、corpus。
...
- Institutional Updates：103 条进入跟踪；高频信号：openai.com、anthropic.com、deepmind.google、research.google、nvidia.com、microsoft.com、partnership、meta.com。
...
- Context Compression / Long Context / Memory：88 条进入跟踪；高频信号：nlp、attention、language model、robotics、KV cache、long-context、framework、inference。
...
- Model Distillation / Model Compression / Efficient Training：84 条进入跟踪；高频信号：nlp、distillation、robotics、framework、cs.LG、language model、low-rank、inference。
...
- RL：72 条进入跟踪；高频信号：nlp、reinforcement learning、rl、framework、optimization、robotics、cs.LG、grpo。
...
- Novel Class Discovery / Open-World Learning / OOD / Continual Learning：70 条进入跟踪；高频信号：nlp、robotics、cs.LG、framework、clustering、out-of-distribution、language model、ood。
...
- GitHub / Open Source Projects：41 条进入跟踪；高频信号：github、github.com、open-source、framework、implementation、language model、dataset、benchmark。
...
- Other Highlights：本月可继续沿着 [The Unfireable Safety Kernel: Execution-Time AI Alignment for AI Agents and Other Escapable AI Systems](https://arxiv.org/abs/2606.26057v1) 追踪。
- Learning Methods / Optimization / Representation Learning：本月可继续沿着 [Stochastic Gradient Optimization with Model-Assisted Sampling](https://arxiv.org/abs/2606.27171v1) 追踪。
