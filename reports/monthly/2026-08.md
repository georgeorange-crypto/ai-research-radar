...
- 纳入日报：25 份
- 跟踪条目：3296；MUST_READ 24；SKIM 107；ARCHIVE 551
...
## 分方向趋势
- Embodied Intelligence / VLA / World Models：1062 条进入跟踪；高频信号：nlp、robotics、cs.AI、cs.CV、framework、language model、cs.LG、image。
...
- AI Systems / HPC / Distributed Training & Inference：952 条进入跟踪；高频信号：HPC、data path、cs.LG、systems、nlp、framework、robotics、cs.DC。
...
- Benchmark / Dataset / Evaluation：354 条进入跟踪；高频信号：benchmark、evaluation、nlp、cs.AI、language model、robotics、dataset、framework。
...
- Agent / Reasoning / Inference-time Scaling / Planning：290 条进入跟踪；高频信号：agent、framework、reasoning、language model、agentic、nlp、cs.AI、inference。
...
- NLP：111 条进入跟踪；高频信号：nlp、cs.CL、robotics、language model、framework、evaluation、corpus、inference。
...
- Institutional Updates：81 条进入跟踪；高频信号：openai.com、anthropic.com、deepmind.google、research.google、microsoft.com、nvidia.com、meta.com、partnership。
...
- Compression / Reliability for AI Infrastructure：71 条进入跟踪；高频信号：nlp、cs.LG、robotics、framework、cs.NI、HPC、data path、compression。
...
- CV：71 条进入跟踪；高频信号：image、diffusion、framework、multimodal、visual、video、language model、github。
...
- Agent Runtime / RL Infrastructure / Scheduling：57 条进入跟踪；高频信号：agent、cs.AI、nlp、cs.LG、robotics、framework、environment、runtime。
...
- Context Compression / Long Context / Memory：28 条进入跟踪；高频信号：agent、long-context、attention、inference、RAG、cs.CL、framework、language model。
