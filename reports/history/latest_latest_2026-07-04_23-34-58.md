...
- [Morphing into Hybrid Attention Models](https://arxiv.org/abs/2606.30562)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.78，global 0.49）
- [Know Your Source: A Public Knowledge Store for Media Background Checks](https://arxiv.org/abs/2607.02383v1)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.78，global 0.38）
...
- 建议行动：skim
- 评分：global_score 0.38；personal_score 0.94；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.00；community_signal 0.08；actionability 0.53；research_relevance 0.96；hype_risk 0.00
- 多源信号：论文:arXiv AI/ML/NLP/Vision/Robotics
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
...
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.38；personal_score 0.93；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.00；community_signal 0.08；actionability 0.52；research_relevance 0.94；hype_risk 0.00
- 多源信号：论文:arXiv AI/ML/NLP/Vision/Robotics
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
...
- [The website of the future may assemble itself for every visitor](https://www.latent.space/p/the-website-of-the-future)（ARCHIVE，Agent / Reasoning / Inference-time Scaling / Planning，证据 full text，personal 0.56，global 0.30）
...
#### Watch
- [MARVEL: Margin-Aware Robust von Mises-Fischer Expert Learning for Long-Tailed Out-of-Distribution Detection](https://arxiv.org/abs/2607.02435v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.93，global 0.41）
- [Denser neq Better: Limits of On-Policy Self-Distillation for Continual Post-Training](https://arxiv.org/abs/2607.01763)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.87，global 0.51）
...
#### Watch
- [DuoMem: Towards Capable On-Device Memory Agents via Dual-Space Distillation](https://arxiv.org/abs/2606.29961)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.87，global 0.47）
- [Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling](https://arxiv.org/abs/2607.01642)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.85，global 0.51）
- [When Token Compression Breaks: Structural Pruning vs. Token Reduction for Robust ViT Segmentation under High Compression](https://arxiv.org/abs/2607.02237v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.82，global 0.40）
...
### CV
- [Alignment Is All You Need For X-to-4D Generation](https://arxiv.org/abs/2607.02516v1)（WATCH，CV，证据 abstract only，personal 0.82，global 0.40）
- [Towards Robustness against Typographic Attack with Training-free Concept Localization](https://arxiv.org/abs/2607.02494v1)（WATCH，CV，证据 abstract only，personal 0.81，global 0.39）

### NLP
- [BamiBERT: A New BERT-based Language Model for Vietnamese](https://arxiv.org/abs/2607.02259v1)（WATCH，NLP，证据 abstract only，personal 0.76，global 0.50）
- [Program-as-Weights: A Programming Paradigm for Fuzzy Functions](https://arxiv.org/abs/2607.02512v1)（WATCH，NLP，证据 abstract only，personal 0.76，global 0.41）

### RL
- [Breaking Failure Cascades: Step-Aware Reinforcement Learning for Medical Multimodal Reasoning](https://arxiv.org/abs/2606.31825)（WATCH，RL，证据 abstract only，personal 0.79，global 0.48）
- [Neuron-Aware Data Selection for Annotation-Free LLM Self-Distillation](https://arxiv.org/abs/2607.02460v1)（WATCH，RL，证据 abstract only，personal 0.76，global 0.39）

### Model Architecture
- [Extreme Adaptive Transformer for Time Series Forecasting](https://arxiv.org/abs/2607.02437v1)（WATCH，Model Architecture，证据 abstract only，personal 0.65，global 0.38）
- [SelectTSL: Prompt-Guided Selective Target Sound Localization in Complex Scenarios](https://arxiv.org/abs/2607.02343v1)（WATCH，Model Architecture，证据 abstract only，personal 0.63，global 0.38）

### Learning Methods
- [WattGPU: Predicting Inference Power and Latency on Unseen GPUs and LLMs](https://arxiv.org/abs/2607.02391v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.72，global 0.41）
- [One More Time: Revisiting Neural Quantum States from a Reinforcement Learning Perspective](https://arxiv.org/abs/2607.02292v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.71，global 0.38）

## 3. Other Highlights
- 今日没有达到高影响阈值的 Other Highlights。

Other Watch / Archive：
- [Embodied.cpp: A Portable Inference Runtime of Embodied AI Models on Heterogeneous Robots](https://arxiv.org/abs/2607.02501v1)（WATCH，Other Highlights，证据 abstract only，personal 0.75，global 0.40）
...
- [Learning to Move Before Learning to Do: Task-Agnostic pretraining for VLAs](https://arxiv.org/abs/2607.02466v1)（WATCH，Other Highlights，证据 abstract only，personal 0.70，global 0.40）
- [WorldSample: Closed-loop Real-robot RL with World Modelling](https://arxiv.org/abs/2607.02431v1)（WATCH，Other Highlights，证据 abstract only，personal 0.68，global 0.38）
- [VT-WAM: Visual-Tactile World Action Model for Contact-Rich Manipulation](https://arxiv.org/abs/2607.02503v1)（WATCH，Other Highlights，证据 abstract only，personal 0.61，global 0.39）
- [HEFT: Heavy-Payload Full-size Humanoid Teleoperation with Privileged Motion Guidance and Windowed Payload Curriculum](https://arxiv.org/abs/2607.02332v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.59，global 0.38）
- [Actuator Reality Shaping for Zero-Shot Sim-to-Real Robot Learning](https://arxiv.org/abs/2607.02205v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.58，global 0.37）
...
### Other Benchmarks
- 其余 10 个只进入附录标题列表：reports/appendix/2026-07-04-benchmarks.md
...
- 发布时间：2026-07-03T16:35:48+00:00
...
- 发布时间：2026-07-03T20:44:02+00:00
...
##### 3. [Context-Engine-AI/Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)
- 行动标签：save
- 来源：GitHub AI Research Projects
- 来源类型：聚合/摘要
- source_role：code_actionability
- 证据来源：repo README
- 原文链接：https://github.com/Context-Engine-AI/Context-Engine
- 发布时间：2026-07-03T13:23:31+00:00
- 这是什么？Context-Engine-AI/Context-Engine：开源项目，方向为“GitHub / Open Source Projects”；主要线索：agentic、context compression、github、github.com。
- 解决了什么问题？它关注“GitHub / Open Source Projects”里的 agentic、context compression、github、github.com 等问题。
- 方法或贡献是什么？这是代码仓库条目；优先检查 README、示例、许可证和是否有可复现实验入口。
- 为什么对我重要？tier=save editorial_priority=0.31 按 GitHub 项目动作处理。 personal=0.73，relevance=0.63。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：save
- 评分：global_score 0.61；personal_score 0.73；credibility 0.86；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.71；actionability 1.00；research_relevance 0.63；hype_risk 0.00
- 多源信号：代码:GitHub AI Research Projects
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：GitHub / 开源项目推荐
- 相关标签：Context Compression / Long Context / Memory、Agent / Reasoning / Inference-time Scaling / Planning、Other Highlights、Tool Library
- 命中关键词：agentic、context compression、github、github.com、inference、open-source、repo
- 开源信号：⭐ 398 | 🍴 52 | 📜 MIT
- 示例/文档/复现：示例 ❌ | 文档 ✅ | 脚本 ✅ | 权重 ❌
- README 摘要：Context Engine ships AI agent skills that teach your coding assistant how to use 30+ MCP tools for semantic search, symbol graph navigation, memory, and more. **Recommended:** Install natively from the public GitHub repo: This pulls the skill directly from GitHub and auto-loads MCP tool guidance int
...
## 12. Collection Notes
- Generated at: 2026-07-03T23:38:43.797247+00:00
- Source count: 30
- Raw item count: 557
- Dedup item count: 488
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: kimi
- reason: unauthorized
- Benchmark appendix: reports/appendix/2026-07-04-benchmarks.md

- Report path: reports/daily/2026/07/2026-07-04.md
- Previous report link: reports/daily/2026/07/2026-07-03.md
