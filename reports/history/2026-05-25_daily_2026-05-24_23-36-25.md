...
- Must Read count: 3 (Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；Masked Skill Token Training for Hierarchical Off-Dynamics Transfer；N3P: Accelerated Automated Parking via a Learning-Based Naturalistic Three-Stage Scheme)
- Skim count: 8 (Whole-Body Conditioned Egocentric Video Prediction；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；Gradient-based Planning for World Models at Longer Horizons；Two is better than one: A Collapse-free Multi-Reward RLIF Training Framework；Remember to be Curious: Episodic Context and Persistent Worlds for 3D Exploration)
- Watch count: 12 (ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；MOSS: Self-Evolution through Source-Level Rewriting in Autonomous Agent Systems；RL without TD learning；AwareVLN: Reasoning with Self-awareness for Vision-Language Navigation；Q-RAG: Long Context Multi‑Step Retrieval via Value‑Based Embedder Training)
- Keywords: framework、trajectory、long-horizon、reinforcement learning、nlp、robotics、berkeley.edu、diffusion
...
- [Full Attention Strikes Back: Transferring Full Attention into Sparse within Hundred Training Steps](https://arxiv.org/abs/2605.16928)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.85，global 0.44）
...
- [MOSS: Self-Evolution through Source-Level Rewriting in Autonomous Agent Systems](https://arxiv.org/abs/2605.22794v1)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.96，global 0.35）
...
#### Watch
- [Cross-Domain Human Action Recognition from Multiview Motion and Textual Descriptions](https://arxiv.org/abs/2605.22697v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.82，global 0.48）
...
- [SeqLoRA: Bilevel Orthogonal Adaptation for Continual Multi-Concept Generation](https://arxiv.org/abs/2605.22743v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.77，global 0.34）
...
#### Watch
- [Self-Policy Distillation via Capability-Selective Subspace Projection](https://arxiv.org/abs/2605.22675v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.86，global 0.35）
- [Post-Training is About States, Not Tokens: A State Distribution View of SFT, RL, and On-Policy Distillation](https://arxiv.org/abs/2605.22731v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.79，global 0.36）
...
#### Archive
- [LoREnc: Low-Rank Encryption for Securing Foundation Models and LoRA Adapters](https://arxiv.org/abs/2605.13163)（ARCHIVE，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.67，global 0.42）
...
### CV
- [MotiMotion: Motion-Controlled Video Generation with Visual Reasoning](https://arxiv.org/abs/2605.22818v1)（WATCH，CV，证据 abstract only，personal 0.81，global 0.36）
- [Which Way Did It Move? Diagnosing and Overcoming Directional Motion Blindness in Video-LLMs](https://arxiv.org/abs/2605.22823v1)（WATCH，CV，证据 abstract only，personal 0.80，global 0.37）

### NLP
- [Understanding Data Temporality Impact on Large Language Models Pre-training](https://arxiv.org/abs/2605.22769v1)（WATCH，NLP，证据 abstract only，personal 0.77，global 0.49）
- [Moral Semantics Survive Machine Translation: Cross-Lingual Evidence from Moral Foundations Corpora](https://arxiv.org/abs/2605.22660v1)（WATCH，NLP，证据 abstract only，personal 0.73，global 0.35）

### RL
- [Vector Policy Optimization: Training for Diversity Improves Test-Time Search](https://arxiv.org/abs/2605.22817v1)（WATCH，RL，证据 abstract only，personal 0.78，global 0.35）
- [A note on convergence of Wasserstein policy optimization](https://arxiv.org/abs/2605.22622v1)（WATCH，RL，证据 abstract only，personal 0.73，global 0.34）
...
- [Same Architecture, Different Capacity: Optimizer-Induced Spectral Scaling Laws](https://arxiv.org/abs/2605.21803)（ARCHIVE，Model Architecture，证据 abstract only，personal 0.64，global 0.45）

### Learning Methods
- [The Double Dilemma in Multi-Task Radiology Report Generation: A Gradient Dynamics Analysis and Solution](https://arxiv.org/abs/2605.22635v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.75，global 0.36）
- [The Matching Principle: A Geometric Theory of Loss Functions for Nuisance-Robust Representation Learning](https://arxiv.org/abs/2605.22800v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.74，global 0.35）

## 3. Other Highlights
- 今日没有达到高影响阈值的 Other Highlights。

Other Watch / Archive：
- [Forecasting Scientific Progress with Artificial Intelligence](https://arxiv.org/abs/2605.22681v1)（WATCH，Other Highlights，证据 abstract only，personal 0.75，global 0.36）
...
- [Superhuman Safe and Agile Racing through Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.22748v1)（WATCH，Other Highlights，证据 abstract only，personal 0.71，global 0.34）
...
- [MoSA: Motion-constrained Stress Adaptation for Mitigating Real-to-Sim Gap in Continuum Dynamics via Learning Residual Anisotropy](https://arxiv.org/abs/2605.22597v1)（WATCH，Other Highlights，证据 abstract only，personal 0.70，global 0.35）
- [Contractual Skills: A GovernSpec Design Framework for Enterprise AI Agents](https://arxiv.org/abs/2605.22634v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.68，global 0.36）
- [MambaGaze: Bidirectional Mamba with Explicit Missing Data Modeling for Cognitive Load Assessment from Eye-Gaze Tracking Data](https://arxiv.org/abs/2605.22775v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.67，global 0.36）
- [Can AI Make Conflicts Worse? An Alignment Failure in LLM Deployment Across Conflict Contexts](https://arxiv.org/abs/2605.22720v1)（WATCH，Other Highlights，证据 abstract only，personal 0.64，global 0.47）
...
##### 2. [Agentic CLEAR: Automating Multi-Level Evaluation of LLM Agents](https://arxiv.org/abs/2605.22608v1)
- 阅读层级：WATCH
...
##### 4. [Boiling the Frog: A Multi-Turn Benchmark for Agentic Safety](https://arxiv.org/abs/2605.22643v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 5. [VGenST-Bench: A Benchmark for Spatio-Temporal Reasoning via Active Video Synthesis](https://arxiv.org/abs/2605.22570v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 5. [Beyond Chamfer Distance: Granular Order-aware Evaluation Metric For Online Mapping](https://arxiv.org/abs/2605.22578v1)
- 阅读层级：ARCHIVE
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
### Other Benchmarks
- 其余 12 个只进入附录标题列表：reports/appendix/2026-05-25-benchmarks.md
...
- 发布时间：2026-05-24T23:26:21+00:00
...
- 今日新论文继承了什么问题：Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；N3P: Accelerated Automated Parking via a Learning-Based Naturalistic Three-Stage Scheme；Masked Skill Token Training for Hierarchical Off-Dynamics Transfer 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
...
- 相关今日条目：
  ...
  - [N3P: Accelerated Automated Parking via a Learning-Based Naturalistic Three-Stage Scheme](https://arxiv.org/abs/2605.22722v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、long-horizon、reinforcement learning、rl）
  - [Masked Skill Token Training for Hierarchical Off-Dynamics Transfer](https://openreview.net/forum?id=K4ngUOra9m)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、reinforcement learning、rl）
...
- [N3P: Accelerated Automated Parking via a Learning-Based Naturalistic Three-Stage Scheme](https://arxiv.org/abs/2605.22722v1)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-05-24T23:36:25.241330+00:00
- Source count: 32
- Raw item count: 688
...
- provider_disabled: none
- reason: none
- Benchmark appendix: reports/appendix/2026-05-25-benchmarks.md

- Report path: reports/daily/2026/05/2026-05-25.md
- Previous report link: reports/daily/2026/05/2026-05-24.md
