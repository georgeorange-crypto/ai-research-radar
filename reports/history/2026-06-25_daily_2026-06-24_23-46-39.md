...
- Must Read count: 3 (Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；Qwen-AgentWorld: Language World Models for General Agents；MEMPROBE: Probing Long-Term Agent Memory via Hidden User-State Recovery)
- Skim count: 8 (SAFARI: Scaling Long Horizon Agentic Fault Attribution via Active Investigation；VisCritic: Visual State Comparison as Process Reward for GUI Agents；FlowPipe: LLM-Enhanced Conditional Generative Flow Networks for Data Preparation Pipeline Construction；Enabling Robust Cloth Manipulation via Inference-Time Simulator-in-the-Loop Refinement；Governed Shared Memory for Multi-Agent LLM Systems)
- Watch count: 12 (SHERLOC: Structured Diagnostic Localization for Code Repair Agents；Whole-Body Conditioned Egocentric Video Prediction；ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；RL without TD learning)
- Keywords: nlp、framework、robotics、benchmark、planning、trajectory、long-horizon、agentic
...
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.24535v1
- 发布时间：2026-06-23T13:04:14+00:00
- 这是什么？Governed Shared Memory for Multi-Agent LLM Systems：研究论文，方向为“Context Compression / Long Context / Memory”；主要线索：agent memory、foundational、long-context、multi-agent。
- 解决了什么问题？它关注“Context Compression / Long Context / Memory”里的 agent memory、foundational、long-context、multi-agent 等问题。
- 方法或贡献是什么？摘要可确认它偏向评测或数据构建；具体任务定义、指标和样本规模需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.95 今天快速扫读。 personal=0.89，relevance=0.83。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.39；personal_score 0.89；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.00；community_signal 0.08；actionability 0.60；research_relevance 0.83；hype_risk 0.00
- 多源信号：论文:arXiv AI/ML/NLP/Vision/Robotics
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：上下文压缩 / 长上下文 / 记忆
- 相关标签：Agent / Reasoning / Inference-time Scaling / Planning、Benchmark / Dataset / Evaluation、Other Highlights、NLP
- 命中关键词：agent memory、evaluation、foundational、long-context、multi-agent、nlp、reproducible、robotics、systems
...
- [CrossPool: Efficient Multi-LLM Serving for Cold MoE Models through KV-Cache and Weight Disaggregation](https://arxiv.org/abs/2606.24506v1)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.88，global 0.38）
...
#### Must Read
##### 1. [Qwen-AgentWorld: Language World Models for General Agents](https://arxiv.org/abs/2606.24597v1)
- 阅读层级：MUST_READ
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 来源类型：一手来源
- source_role：paper_source
...
- 发布时间：2026-06-23T13:53:55+00:00
- 这是什么？Qwen-AgentWorld: Language World Models for General Agents：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：agentic、agentic RL、cs.CL、environment。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 agentic、agentic RL、cs.CL、environment 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 agentic、agentic RL、cs.CL、environment；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=MUST_READ editorial_priority=0.96 今天安排深读。 personal=1.00，relevance=1.00。
- 是否建议深读？建议今天深读。
- 建议行动：read_pdf
- 评分：global_score 0.42；personal_score 1.00；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.05；community_signal 0.10；actionability 0.82；research_relevance 1.00；hype_risk 0.00
...
- 命中关键词：agentic、agentic RL、benchmark、cs.CL、environment、framework、github、language model、nlp、planning
...
- source_role：paper_source
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.24626v1
- 发布时间：2026-06-23T14:23:40+00:00
- 这是什么？SAFARI: Scaling Long Horizon Agentic Fault Attribution via Active Investigation：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：agentic、attention、autonomous agent、context window。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 agentic、attention、autonomous agent、context window 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 agentic、attention、autonomous agent、context window；具体训练设置、指标和消融细节需读原文确认。
...
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：Context Compression / Long Context / Memory、Benchmark / Dataset / Evaluation、NLP、Model Architecture
- 命中关键词：agentic、attention、autonomous agent、context window、dataset、framework、long horizon、long-horizon、multi-agent、nlp

##### 2. [VisCritic: Visual State Comparison as Process Reward for GUI Agents](https://arxiv.org/abs/2606.24525v1)
- 阅读层级：SKIM
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 来源类型：一手来源
- source_role：paper_source
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.24525v1
- 发布时间：2026-06-23T12:57:02+00:00
- 这是什么？VisCritic: Visual State Comparison as Process Reward for GUI Agents：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：GUI agent、cs.CV、framework、language model。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 GUI agent、cs.CV、framework、language model 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 GUI agent、cs.CV、framework、language model；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.94 今天快速扫读。 personal=0.96，relevance=0.96。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
...
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：CV、Benchmark / Dataset / Evaluation、NLP、RL
- 命中关键词：GUI agent、benchmark、cs.CV、framework、language model、long-horizon、metrics、nlp、reasoning、reward model

#### Watch
- [SHERLOC: Structured Diagnostic Localization for Code Repair Agents](https://arxiv.org/abs/2606.24820v1)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.98，global 0.39）
...
#### Watch
- [Vision-Language Model Reasoning for Contextual Semantic Mapping in Intralogistics](https://arxiv.org/abs/2606.24814v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.88，global 0.38）
- [Compact Object-Level Representations with Open-Vocabulary Understanding for Indoor Visual Relocalization](https://arxiv.org/abs/2606.24767v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.78，global 0.38）
...
#### Watch
- [Scaling Laws for Task-Specific LLM Distillation](https://arxiv.org/abs/2606.24747v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.91，global 0.40）
- [Heterogeneous Knowledge Distillation via Geometry Decoupling and Momentum-Aware Gradient Regulation](https://arxiv.org/abs/2606.24557v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.90，global 0.39）
- [Pocket-SLAM: Rendering-Area-Aware Pruning for Memory-Efficient 3DGS-SLAM](https://arxiv.org/abs/2606.24796v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.79，global 0.40）
...
### CV
- [UniDrive: A Unified Vision-Language and Grounding Framework for Interpretable Risk Understanding in Autonomous Driving](https://arxiv.org/abs/2606.24759v1)（WATCH，CV，证据 abstract only，personal 0.85，global 0.40）
- [BioMedVR: Confusion-Aware Mixture-of-Prompt Experts for Biomedical Visual Reprogramming](https://arxiv.org/abs/2606.24740v1)（WATCH，CV，证据 abstract only，personal 0.81，global 0.39）

### NLP
- [Matching Tasks to Objectives: Fine-Tuning and Prompt-Tuning Strategies for Encoder-Decoder Pre-trained Language Models](https://arxiv.org/abs/2606.24841v1)（WATCH，NLP，证据 abstract only，personal 0.83，global 0.40）
- [Privacy-Preserving RAG via Multi-Agent Semantic Rewriting: Achieving Confidentiality Without Compromising Contextual Fidelity](https://arxiv.org/abs/2606.24623v1)（WATCH，NLP，证据 abstract only，personal 0.78，global 0.41）

### RL
- [LaGO: Latent Action Guidance for Online Reinforcement Learning](https://arxiv.org/abs/2606.24669v1)（WATCH，RL，证据 abstract only，personal 0.76，global 0.39）
- [Themis: An explainable AI-enabled framework for Reinforcement Learning with Human Feedback](https://arxiv.org/abs/2606.24622v1)（WATCH，RL，证据 abstract only，personal 0.76，global 0.47）
...
- [QG-MIL: A Gated Transformer Aggregator for Domain-Agnostic Multiple Instance Learning in Medical Imaging](https://arxiv.org/abs/2606.20027)（ARCHIVE，Model Architecture，证据 abstract only，personal 0.64，global 0.42）

### Learning Methods
- [Grad Detect: Gradient-Based Hallucination Detection in LLMs](https://arxiv.org/abs/2606.24790v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.68，global 0.39）
- [A Physics-Informed Fourier-Wavelet Transformer for Multiscale Computational Fluid Dynamics Surrogate Modeling](https://arxiv.org/abs/2606.24696v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.66，global 0.38）
...
- [BluTrain: A C++/CUDA Framework for AI Systems](https://arxiv.org/abs/2606.24780v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.63，global 0.39）
- [Explaining Failures of Cyber-Physical Systems with Actual Causality](https://arxiv.org/abs/2606.24546v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.61，global 0.38）
- [Beyond Monotonic Progress: Retry-Supervised Value Learning for Robot Imitation](https://arxiv.org/abs/2606.24633v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.59，global 0.38）
- [AOHP: An Open-Source OS-Level Agent Harness for Personalized, Efficient and Secure Interaction](https://arxiv.org/abs/2606.23449)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.58，global 0.48）
- [OpenAI and Broadcom unveil LLM-optimized inference chip](https://openai.com/index/openai-broadcom-jalapeno-inference-chip)（WATCH，Other Highlights，证据 full text，personal 0.55，global 0.51）
- [Decentralised AI Training and Inference with BlockTrain](https://arxiv.org/abs/2606.24722v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.55，global 0.38）
...
##### 2. [L3Cube-MahaPOS: A Marathi Part-of-Speech Tagging Dataset and BERT Models](https://arxiv.org/abs/2606.24825v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 3. [AdversaBench: Automated LLM Red-Teaming with Multi-Judge Confirmation and Cross-Model Transferability](https://arxiv.org/abs/2606.24589v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 4. [Evaluating the Interpretability of Sparse Autoencoders with Concept Annotations](https://arxiv.org/abs/2606.24716v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
### Other Benchmarks
- 其余 17 个只进入附录标题列表：reports/appendix/2026-06-25-benchmarks.md
...
- 发布时间：2026-06-24T23:03:53+00:00
...
- 发布时间：2026-06-24T23:36:21+00:00
...
- 今日新论文继承了什么问题：Qwen-AgentWorld: Language World Models for General Agents；Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；MEMPROBE: Probing Long-Term Agent Memory via Hidden User-State Recovery 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
- 它挑战了什么经典假设：它挑战固定单轨迹、人工指定控制流或只看任务成功率的假设，转向并行、自适应和轨迹级评估。
- 它推进到什么新场景：新场景扩展到长程规划、agentic RL、支付/网页/GUI workflow 与并行推理执行。
- 预备知识：熟悉 prompting、chain-of-thought 和基础强化学习任务表述。
- 相关今日条目：
  - [Qwen-AgentWorld: Language World Models for General Agents](https://arxiv.org/abs/2606.24597v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、planning、reasoning）
  ...
  - [MEMPROBE: Probing Long-Term Agent Memory via Hidden User-State Recovery](https://arxiv.org/abs/2606.24595v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、llm agent）
...
- [Qwen-AgentWorld: Language World Models for General Agents](https://arxiv.org/abs/2606.24597v1)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。
- [MEMPROBE: Probing Long-Term Agent Memory via Hidden User-State Recovery](https://arxiv.org/abs/2606.24595v1)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-06-24T23:46:37.322594+00:00
- Source count: 30
- Raw item count: 664
- Dedup item count: 598
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: kimi
- reason: unauthorized
- Benchmark appendix: reports/appendix/2026-06-25-benchmarks.md

- Report path: reports/daily/2026/06/2026-06-25.md
- Previous report link: reports/daily/2026/06/2026-06-24.md
