...
- Must Read count: 3 (Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；Masked Skill Token Training for Hierarchical Off-Dynamics Transfer；Learning from Language Feedback via Variational Policy Distillation)
- Skim count: 8 (Whole-Body Conditioned Egocentric Video Prediction；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；RL without TD learning；Gradient-based Planning for World Models at Longer Horizons；OScaR: The Occam's Razor for Extreme KV Cache Quantization in LLMs and Beyond)
- Watch count: 12 (ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；Mix-Quant: Quantized Prefilling, Precise Decoding for Agentic LLMs；Q-RAG: Long Context Multi‑Step Retrieval via Value‑Based Embedder Training；Identifying Interactions at Scale for LLMs；IndusAgent: Reinforcing Open-Vocabulary Industrial Anomaly Detection with Agentic Tools)
- Keywords: environment、berkeley.edu、framework、evaluation、diffusion、KV cache、attention、inference
...
#### Skim
##### 1. [OScaR: The Occam's Razor for Extreme KV Cache Quantization in LLMs and Beyond](https://arxiv.org/abs/2605.19660)
- 阅读层级：SKIM
- 来源：Hugging Face Daily Papers
- 来源类型：聚合/摘要
- source_role：paper_source
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2605.19660
- 发布时间：2026-05-18T20:00:00+00:00
- 这是什么？OScaR: The Occam's Razor for Extreme KV Cache Quantization in LLMs and Beyond：研究论文，方向为“Context Compression / Long Context / Memory”；主要线索：KV cache、framework、github、implementation。
- 解决了什么问题？它关注“Context Compression / Long Context / Memory”里的 KV cache、framework、github、implementation 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 KV cache、framework、github、implementation；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.88 今天快速扫读。 personal=0.88，relevance=0.82。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.50；personal_score 0.88；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.28；actionability 0.68；research_relevance 0.82；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：上下文压缩 / 长上下文 / 记忆
- 相关标签：Agent / Reasoning / Inference-time Scaling / Planning、Model Distillation / Model Compression / Efficient Training、GitHub / Open Source Projects
- 命中关键词：KV cache、framework、github、implementation、long-context、quantization、reasoning

##### 2. [OCTOPUS: Optimized KV Cache for Transformers via Octahedral Parametrization Under optimal Squared error quantization](https://arxiv.org/abs/2605.21226)
- 阅读层级：SKIM
- 来源：Hugging Face Daily Papers
- 来源类型：聚合/摘要
- source_role：paper_source
...
- 发布时间：2026-05-19T20:00:00+00:00
- 这是什么？OCTOPUS: Optimized KV Cache for Transformers via Octahedral Parametrization Under optimal Squared error quantization：研究论文，方向为“Context Compression / Long Context / Memory”；主要线索：KV cache、github、implementation、inference。
- 解决了什么问题？它关注“Context Compression / Long Context / Memory”里的 KV cache、github、implementation、inference 等问题。
- 方法或贡献是什么？方法细节未在摘要中充分展开，细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.90 今天快速扫读。 personal=0.86，relevance=0.82。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.50；personal_score 0.86；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.19；actionability 0.56；research_relevance 0.82；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：上下文压缩 / 长上下文 / 记忆
- 相关标签：Model Distillation / Model Compression / Efficient Training、GitHub / Open Source Projects、CV、Other Highlights
- 命中关键词：KV cache、github、implementation、inference、long-context、quantization、video
...
- [SANA-Video: Efficient Video Generation with Block Linear Diffusion Transformer](https://arxiv.org/abs/2509.24695)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.76，global 0.42）

#### Archive
- [MOCHA: Multi-Objective Chebyshev Annealing for Agent Skill Optimization](https://arxiv.org/abs/2605.19330)（ARCHIVE，Context Compression / Long Context / Memory，证据 abstract only，personal 0.67，global 0.45）
...
##### 2. [Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment](http://bair.berkeley.edu/blog/2025/03/25/rl-av-smoothing/)
- 阅读层级：SKIM
- 来源：BAIR Blog
- 来源类型：一手来源
- source_role：institution_authority
...
- 这是什么？Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment 是一篇围绕 Agent / Reasoning / Inference-time Scaling / Planning 的研究或技术文章；从正文摘要看，重点是：Training Diffusion Models with Reinforcement Learning We deployed 100 reinforcement learning (RL)-controlled cars into rush-hour highway traffic to smooth congestion and reduce fuel consumption for everyone. Our goal is to tackle "stop-and-go" waves , those frustrating slowdowns and speedups that usually have no clear cause but lead to congestion and significant energy waste. To train efficient flow-smoothing controllers, we built fast, data-driven simulations that RL agents interact with, learning to maximize ene…
- 解决了什么问题？它关注 Agent / Reasoning / Inference-time Scaling / Planning 中尚未被充分解决的建模、推理、系统或评测问题，具体问题线索来自原文正文而不是标题关键词。
- 方法或贡献是什么？它的贡献需要按正文脉络理解：先界定问题，再给出方法、系统设计、实验观察或研究范式，而不是只用关键词归类。
- 为什么对我重要？该来源具备 full text grounding，适合用作当天判断 Agent / Reasoning / Inference-time Scaling / Planning 方向变化的实质材料；personal=0.96, relevance=1.00。
- 是否建议深读？建议略读正文，先抓住问题定义和方法框架。
- 建议行动：skim
- 评分：global_score 0.37；personal_score 0.96；credibility 1.00；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.08；actionability 0.65；research_relevance 1.00；hype_risk 0.00
- 多源信号：机构:BAIR Blog
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：CV、Benchmark / Dataset / Evaluation、RL、Other Highlights
- 命中关键词：berkeley.edu、computer vision、dataset、diffusion、environment、framework、metrics、multi-agent、planning、reinforcement learning
...
- [Mix-Quant: Quantized Prefilling, Precise Decoding for Agentic LLMs](https://arxiv.org/abs/2605.20315)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.96，global 0.49）
- [IndusAgent: Reinforcing Open-Vocabulary Industrial Anomaly Detection with Agentic Tools](https://arxiv.org/abs/2605.20682)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.92，global 0.54）
...
- [Sea's View on the Future of Agentic Software Development with Codex](https://openai.com/index/sea-david-chen)（ARCHIVE，Agent / Reasoning / Inference-time Scaling / Planning，证据 full text，personal 0.64，global 0.40）
...
#### Watch
- [Safety Alignment as Continual Learning: Mitigating the Alignment Tax via Orthogonal Gradient Projection](https://arxiv.org/abs/2602.07892)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.80，global 0.42）
...
#### Archive
- [Capturing LLM Capabilities via Evidence-Calibrated Query Clustering](https://arxiv.org/abs/2605.17110)（ARCHIVE，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.68，global 0.45）
...
- [TIDE: Efficient and Lossless MoE Diffusion LLM Inference with I/O-aware Expert Offload](https://arxiv.org/abs/2605.20179)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.73，global 0.45）
...
- [BalCapRL: A Balanced Framework for RL-Based MLLM Image Captioning](https://machinelearning.apple.com/research/balcaprl-mllm-image-captioning)（ARCHIVE，CV，证据 full text，personal 0.72，global 0.31）
...
### RL
- [Conditional Equivalence of DPO and RLHF: Implicit Assumption, Failure Modes, and Provable Alignment](https://arxiv.org/abs/2605.20834)（WATCH，RL，证据 abstract only，personal 0.71，global 0.50）
...
- [HRM-Text: Efficient Pretraining Beyond Scaling](https://arxiv.org/abs/2605.20613)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.55，global 0.53）
...
- [PanoWorld: A Generative Spatial World Model for Consistent Whole-House Panorama Synthesis](https://arxiv.org/abs/2605.17916)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.52，global 0.45）
...
- [This robot helps you lift objects — by looking at your biceps](https://www.csail.mit.edu/news/robot-helps-you-lift-objects-looking-your-biceps)（ARCHIVE，Other Highlights，证据 full text，personal 0.50，global 0.35）
- [Kernel conditional tests from learning-theoretic bounds](https://openreview.net/forum?id=hJKDwf32Xu)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.49，global 0.27）
...
##### 2. [Evaluating Temporal Semantic Caching and Workflow Optimization in Agentic Plan-Execute Pipelines](https://arxiv.org/abs/2605.20630)
- 阅读层级：WATCH
- 来源：Hugging Face Daily Papers
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 3. [MINTEval: Evaluating Memory under Multi-Target Interference in Long-Horizon Agent Systems](https://arxiv.org/abs/2605.18565)
- 阅读层级：WATCH
- 来源：Hugging Face Daily Papers
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 5. [CutVerse: A Compositional GUI Agents Benchmark for Media Post-Production Editing](https://arxiv.org/abs/2605.19484)
- 阅读层级：WATCH
- 来源：Hugging Face Daily Papers
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 3. [Fairness via Independence: A General Regularization Framework for Machine Learning](https://openreview.net/forum?id=sbEb0Ld6MK)
- 阅读层级：ARCHIVE
- 来源：OpenReview (ICLR.cc/2026/Conference)
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 4. [Not Search, But Scan: Benchmarking MLLMs on Scan-Oriented Academic Paper Reasoning](https://openreview.net/forum?id=GDA1yB6yDP)
- 阅读层级：ARCHIVE
- 来源：OpenReview (ICLR.cc/2026/Conference)
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 5. [THEMIS: Towards Holistic Evaluation of MLLMs for Scientific Paper Fraud Forensics](https://openreview.net/forum?id=y3UkklvoW9)
- 阅读层级：ARCHIVE
- 来源：OpenReview (ICLR.cc/2026/Conference)
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
### Other Benchmarks
- 其余 12 个只进入附录标题列表：reports/appendix/2026-05-22-benchmarks.md
...
- 发布时间：2026-05-21T21:39:26+00:00
...
- 发布时间：2026-05-21T23:34:56+00:00
...
- 今日新论文继承了什么问题：Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；Masked Skill Token Training for Hierarchical Off-Dynamics Transfer；Learning from Language Feedback via Variational Policy Distillation 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
...
- 相关今日条目：
  ...
  - [Learning from Language Feedback via Variational Policy Distillation](https://arxiv.org/abs/2605.15113)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、reasoning）
...
- [Learning from Language Feedback via Variational Policy Distillation](https://arxiv.org/abs/2605.15113)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-05-21T23:37:51.909599+00:00
- Source count: 31
- Raw item count: 568
- Dedup item count: 506
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: none
- reason: none
- Benchmark appendix: reports/appendix/2026-05-22-benchmarks.md

- Report path: reports/daily/2026/05/2026-05-22.md
- Previous report link: reports/daily/2026/05/2026-05-21.md

## Source Health
- arXiv AI/ML/NLP/Vision/Robotics: error (0 items) - 429 Client Error: Unknown Error for url: https://export.arxiv.org/api/query?search_query=cat%3Acs.AI+OR+cat%3Acs.LG+OR+cat%3Acs.CL+OR+cat%3Acs.CV+OR+cat%3Acs.RO+OR+cat%3Astat.ML&sortBy=submittedDate&s
