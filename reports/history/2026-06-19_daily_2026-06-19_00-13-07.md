...
- Must Read count: 3 (Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；A Mixed-Reality Testbed for Autonomous Vehicles；REVES: REvision and VErification--Augmented Training for Test-Time Scaling)
- Skim count: 8 (Native Active Perception as Reasoning for Omni-Modal Understanding；STARE: Surprisal-Guided Token-Level Advantage Reweighting for Policy Entropy Stability；Zero-Shot Long-Horizon Dexterous Manipulation via Multi-View 3D-Grounded VLM Reasoning；Beyond Safe Data: Pretraining-Stage Alignment with Regular Safety Reflection；Mobile Pedipulation for Object Sliding via Hierarchical Control on a Wheeled Bipedal Robot)
- Watch count: 12 (Whole-Body Conditioned Egocentric Video Prediction；ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；Guava: An Effective and Universal Harness for Embodied Manipulation；SciOrch: Learning to Orchestrate Expert LLMs for Solving Frontier Multimodal Scientific Reasoning Tasks；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment)
- Keywords: nlp、robotics、framework、reasoning、trajectory、inference、cs.RO、environment
...
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.19341v1
- 发布时间：2026-06-17T17:59:56+00:00
- 这是什么？Native Active Perception as Reasoning for Omni-Modal Understanding：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：agentic、cs.CL、cs.CV、nlp。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 agentic、cs.CL、cs.CV、nlp 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 agentic、cs.CL、cs.CV、nlp；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.95 今天快速扫读。 personal=0.97，relevance=1.00。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.40；personal_score 0.97；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.05；community_signal 0.10；actionability 0.60；research_relevance 1.00；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers/arXiv AI/ML/NLP/Vision/Robotics
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：CV、NLP、RL、GitHub / Open Source Projects
- 命中关键词：agentic、cs.CL、cs.CV、nlp、open-source、reasoning、reinforcement learning、robotics、test-time scaling、trajectory
- 去重信息：同一内容也出现在 Hugging Face Daily Papers、arXiv AI/ML/NLP/Vision/Robotics

##### 2. [STARE: Surprisal-Guided Token-Level Advantage Reweighting for Policy Entropy Stability](https://arxiv.org/abs/2606.19236v1)
- 阅读层级：SKIM
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 来源类型：一手来源
- source_role：paper_source
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.19236v1
- 发布时间：2026-06-17T16:13:42+00:00
- 这是什么？STARE: Surprisal-Guided Token-Level Advantage Reweighting for Policy Entropy Stability：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：cs.CL、cs.LG、github、gradient。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 cs.CL、cs.LG、github、gradient 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 cs.CL、cs.LG、github、gradient；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.95 今天快速扫读。 personal=0.97，relevance=0.96。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.40；personal_score 0.97；credibility 1.00；conference 0.00；institution 0.00；multi_source 0.05；community_signal 0.10；actionability 0.69；research_relevance 0.96；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers/arXiv AI/ML/NLP/Vision/Robotics
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：RL、NLP、Learning Methods / Optimization / Representation Learning、GitHub / Open Source Projects
- 命中关键词：cs.CL、cs.LG、github、gradient、grpo、nlp、reasoning、reinforcement learning、rl、robotics
- 去重信息：同一内容也出现在 Hugging Face Daily Papers、arXiv AI/ML/NLP/Vision/Robotics
...
- [Guava: An Effective and Universal Harness for Embodied Manipulation](https://arxiv.org/abs/2606.18363)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.97，global 0.49）
...
#### Watch
- [Complementary Attention Head Pruning for Efficient Transformers](https://arxiv.org/abs/2606.19150v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.81，global 0.38）
...
- [OrthoReg: Orthogonal Regularization for Hybrid Symbolic-Neural Dynamical Systems](https://arxiv.org/abs/2606.19145v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.78，global 0.39）
...
#### Watch
- [NeSyCat Torch: A Differentiable Tensor Implementation of Categorical Semantics for Neurosymbolic Learning](https://arxiv.org/abs/2606.19279v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.80，global 0.39）
...
- [Essential Subspace Merging for Multi-Task Learning](https://arxiv.org/abs/2606.19164v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.72，global 0.38）

#### Archive
- [Trust the Right Teacher: Quality-Aware Self-Distillation for GUI Grounding](https://arxiv.org/abs/2606.18101)（ARCHIVE，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.67，global 0.46）
...
### CV
- [AMALIA-VL: A Native European Portuguese Open-Source Vision and Language Model](https://arxiv.org/abs/2606.19100v1)（WATCH，CV，证据 abstract only，personal 0.82，global 0.40）
- [Seeing Before Reasoning: Decoupling Perception and Reasoning for Shortcut-Resilient Multimodal On-Policy Self-Distillation](https://arxiv.org/abs/2606.19120v1)（WATCH，CV，证据 abstract only，personal 0.80，global 0.40）

### NLP
- [DreamReasoner-8B: Block-Size Curriculum Learning for Diffusion Reasoning Models](https://arxiv.org/abs/2606.19257v1)（WATCH，NLP，证据 abstract only，personal 0.78，global 0.41）
- [Rethinking Reward Supervision: Rubric-Conditioned Self-Distillation](https://arxiv.org/abs/2606.19327v1)（WATCH，NLP，证据 abstract only，personal 0.75，global 0.39）
...
- [Model-Free Reinforcement Learning Control for Resilient Cyber-Physical Systems](https://arxiv.org/abs/2606.19069v1)（WATCH，RL，证据 abstract only，personal 0.72，global 0.38）

### Model Architecture
- [Towards an Agent-First Web: Redesigning the Web for AI Agents](https://arxiv.org/abs/2606.19116v1)（WATCH，Model Architecture，证据 abstract only，personal 0.66，global 0.39）
- [ROSA-TFormer: A Radar-Optical Sensor-Aware Temporal Transformer for Pinus sylvestris Plantation Classification in Northern Shaanxi Using GEE-Derived Sentinel-1/2 Time Series](https://arxiv.org/abs/2606.19204v1)（WATCH，Model Architecture，证据 abstract only，personal 0.63，global 0.38）

### Learning Methods
- [Monocular 3D Occupancy Perception for Robots on Sidewalks via Hybrid 2D-3D Learning](https://arxiv.org/abs/2606.19122v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.76，global 0.40）
- [The Chandra-Gaia Catalog of Counterparts: Resolving ambiguous Gaia matches to X-ray sources in the Chandra Source Catalog using Machine Learning](https://arxiv.org/abs/2606.19329v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.71，global 0.39）
...
- [FAST-LIVGO: A Degeneracy-Robust LiDAR-Inertial-Visual-GNSS Fusion Odometry](https://arxiv.org/abs/2606.19190v1)（WATCH，Other Highlights，证据 abstract only，personal 0.68，global 0.39）
- [ART-VS: Adaptive Resolution Tiling for Vision Transformer Visual Servoing](https://arxiv.org/abs/2606.19089v1)（WATCH，Other Highlights，证据 abstract only，personal 0.68，global 0.39）
- [Seeing Through Occlusion: Deterministic Arm Kinematic Correction for Robot Teleoperation](https://arxiv.org/abs/2606.19240v1)（WATCH，Other Highlights，证据 abstract only，personal 0.63，global 0.37）
- [Observability and Consistency Analysis for Visual-Inertial Navigation with Anchored Feature Parameterizations](https://arxiv.org/abs/2606.19307v1)（WATCH，Other Highlights，证据 abstract only，personal 0.61，global 0.48）
- [Speaking the Language of Science: Toward a General-Purpose Generative Foundation Model for the Natural Sciences](https://arxiv.org/abs/2606.16905)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.61，global 0.47）
- [Analysing drivers and interdependencies in European electricity markets using XAI](https://arxiv.org/abs/2606.19118v1)（WATCH，Other Highlights，证据 abstract only，personal 0.60，global 0.46）
...
##### 2. [TxBench-PP: Analyzing AI Agent Performance on Small-Molecule Preclinical Pharmacology](https://arxiv.org/abs/2606.19245v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 4. [Benchmarking Large Vision-Language Models on Fine-Grained Image Tasks: From Evaluation to Diagnosis](https://arxiv.org/abs/2606.19053v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
...
##### 5. [A Multi-Domain Benchmark for Detecting AI-Generated Text-Rich Images from GPT-Image-2](https://arxiv.org/abs/2606.19259v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 2. [ProductConsistency: Improving Product Identity Preservation in Instruction-Based Image Editing via SFT and RL](https://arxiv.org/abs/2606.19103v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 3. [DREAM: Extending Vision-Language Models with Dual-Objective Encoding for Cross-Modal Retrieval](https://arxiv.org/abs/2606.19062v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 5. [X+Slides: Benchmarking Audience-Conditioned Slide Generation](https://arxiv.org/abs/2606.19256v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
### Other Benchmarks
- 其余 15 个只进入附录标题列表：reports/appendix/2026-06-19-benchmarks.md
...
- 发布时间：2026-06-19T00:03:21+00:00
...
- 今日新论文继承了什么问题：Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；REVES: REvision and VErification--Augmented Training for Test-Time Scaling；A Mixed-Reality Testbed for Autonomous Vehicles 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
...
- 相关今日条目：
  ...
  - [REVES: REvision and VErification--Augmented Training for Test-Time Scaling](https://arxiv.org/abs/2606.18910)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、reasoning、search）
  - [A Mixed-Reality Testbed for Autonomous Vehicles](https://arxiv.org/abs/2606.19267v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、planning）
...
- [A Mixed-Reality Testbed for Autonomous Vehicles](https://arxiv.org/abs/2606.19267v1)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。
- [REVES: REvision and VErification--Augmented Training for Test-Time Scaling](https://arxiv.org/abs/2606.18910)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-06-19T00:13:07.211833+00:00
- Source count: 31
- Raw item count: 675
...
- provider_disabled: none
- reason: none
- Benchmark appendix: reports/appendix/2026-06-19-benchmarks.md

- Report path: reports/daily/2026/06/2026-06-19.md
- Previous report link: reports/daily/2026/06/2026-06-18.md
