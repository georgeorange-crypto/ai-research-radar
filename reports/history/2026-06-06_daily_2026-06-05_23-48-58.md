...
- Must Read count: 3 (You Only Index Once: Cross-Layer Sparse Attention with Shared Routing；Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery)
...
- Watch count: 12 (EvoDS: Self-Evolving Autonomous Data Science Agent with Skill Learning and Context Management；CollabSim: A CSCW-Grounded Methodology for Investigating Collaborative Competence of LLM Agents through Controlled Multi-Agent Experiments；Whole-Body Conditioned Egocentric Video Prediction；ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment)
- Keywords: nlp、robotics、reasoning、framework、language model、KV cache、cs.CL、cs.LG
...
- 为什么对我重要？tier=MUST_READ editorial_priority=0.97 今天安排深读。 personal=0.94，relevance=0.96。
- 是否建议深读？建议今天深读。
- 建议行动：read_pdf
...
- 为什么对我重要？tier=SKIM editorial_priority=0.96 今天快速扫读。 personal=0.93，relevance=0.94。
...
- 为什么对我重要？tier=SKIM editorial_priority=0.96 今天快速扫读。 personal=0.91，relevance=0.87。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
...
- [TempoVLA: Learning Speed-Controllable Vision-Language-Action Policies](https://arxiv.org/abs/2606.06491v1)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.89，global 0.38）
...
- 发布时间：2026-06-04T17:55:59+00:00
- 这是什么？MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：cs.CL、framework、generalization、github。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 cs.CL、framework、generalization、github 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 cs.CL、framework、generalization、github；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=MUST_READ editorial_priority=0.95 今天安排深读。 personal=0.98，relevance=0.96。
- 是否建议深读？建议今天深读。
- 建议行动：read_pdf
...
- 相关标签：NLP、Learning Methods / Optimization / Representation Learning、GitHub / Open Source Projects、Benchmark / Dataset / Evaluation
- 命中关键词：cs.CL、evaluation、framework、generalization、github、language model、long-horizon、multi-agent、nlp、optimization
...
#### Watch
- [EvoDS: Self-Evolving Autonomous Data Science Agent with Skill Learning and Context Management](https://arxiv.org/abs/2606.03841)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.99，global 0.48）
- [CollabSim: A CSCW-Grounded Methodology for Investigating Collaborative Competence of LLM Agents through Controlled Multi-Agent Experiments](https://arxiv.org/abs/2606.06399v1)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.98，global 0.39）
...
#### Watch
- [Flow-based Policy Adaptation without Policy Updates](https://arxiv.org/abs/2606.06461v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.91，global 0.40）
...
### CV
- [PAR3D: A Unified 3D-MLLM with Part-Aware Representation for Scene Understanding](https://arxiv.org/abs/2606.06485v1)（WATCH，CV，证据 abstract only，personal 0.82，global 0.40）
- [Physics in 2-Steps: Locking Motion Priors Before Visual Refinement Erases Them](https://arxiv.org/abs/2606.06361v1)（WATCH，CV，证据 abstract only，personal 0.80，global 0.39）

### NLP
- [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://arxiv.org/abs/2606.06492v1)（WATCH，NLP，证据 abstract only，personal 0.78，global 0.53）
- [Reinforcement Learning Elicits Contextual Learning of Unseen Language Translation](https://arxiv.org/abs/2606.06428v1)（WATCH，NLP，证据 abstract only，personal 0.73，global 0.38）

### RL
- [RREDCoT: Segment-Level Reward Redistribution for Reasoning Models](https://arxiv.org/abs/2606.06475v1)（WATCH，RL，证据 abstract only，personal 0.77，global 0.38）
- [Ensuring Interaction Safety in Multitask Exoskeleton Control: A Simulation-Trained Variable Impedance Framework](https://arxiv.org/abs/2606.06370v1)（WATCH，RL，证据 abstract only，personal 0.70，global 0.39）

### Model Architecture
- [Multi-Resolution Tactile Imitation Learning for Contact-Rich Robotic Manipulation](https://arxiv.org/abs/2606.06281v1)（WATCH，Model Architecture，证据 abstract only，personal 0.74，global 0.39）
- [GRAMformer: Any-Order Modality Interactions via Volumetric Multimodal Cross-Attention](https://arxiv.org/abs/2606.06249v1)（WATCH，Model Architecture，证据 abstract only，personal 0.69，global 0.38）

### Learning Methods
- [Discrete Causal Representations from Heterogeneous Domains: A Bayesian Approach with Social Survey Applications](https://arxiv.org/abs/2606.06288v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.74，global 0.38）
- [PAC-Bayesian Adversarially Robust Generalization for Message Passing Graph Neural Networks: A Sensitivity Analysis](https://arxiv.org/abs/2606.06293v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.74，global 0.38）
...
- [Attitude-Aided Linear Calibration of Triaxial Accelerometers](https://arxiv.org/abs/2606.06308v1)（WATCH，Other Highlights，证据 abstract only，personal 0.71，global 0.38）
- [RadiusFPS: Efficient Farthest Point Sampling on CPUs and GPUs via Spherical Voxel Pruning](https://arxiv.org/abs/2606.06255v1)（WATCH，Other Highlights，证据 abstract only，personal 0.71，global 0.39）
...
- [Quantifying the Privacy of Counterfactuals by Leveraging Membership Inference Attacks Against Synthetic Data](https://arxiv.org/abs/2606.06334v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.58，global 0.38）
- [Equivariant Neural Belief Propagation](https://arxiv.org/abs/2606.06344v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.57，global 0.38）
- [Bentkus-type asymptotic e-values](https://arxiv.org/abs/2606.06332v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.55，global 0.38）
- [Quantum enhanced rare event discovery and sampling](https://arxiv.org/abs/2606.06316v1)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.55，global 0.37）
...
- 今日新论文继承了什么问题：MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery；Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；You Only Index Once: Cross-Layer Sparse Attention with Shared Routing 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
- 它挑战了什么经典假设：它挑战固定单轨迹、人工指定控制流或只看任务成功率的假设，转向并行、自适应和轨迹级评估。
- 它推进到什么新场景：新场景扩展到长程规划、agentic RL、支付/网页/GUI workflow 与并行推理执行。
- 相关今日条目：
  - [MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery](https://arxiv.org/abs/2606.06473v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、planning、search）
...
- 它推进到什么新场景：新场景扩展到长程规划、agentic RL、支付/网页/GUI workflow 与并行推理执行。
- 相关今日条目：
  - [MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery](https://arxiv.org/abs/2606.06473v1)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、planning）
