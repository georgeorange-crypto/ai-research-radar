...
- 必读数量：0
- 略读数量：8（The Handoff Tax: Continuing Non-Native Trajectories in LLM Agents；Prefix Sliding for efficient test-time scaling；Agentic Game Development as a Verifiable Trajectory Data Engine for Scaling World Models；VoiceMem: Streaming Dual-Brain Memory for Real-Time Interaction；Self-OPD: On-Policy Distillation for Flow Matching Models without Teacher）
- 关注数量：12（Securing the AI Agent: A Unified Framework for Multi-Layer Agent Red Teaming；What Makes Good Agentic Data? An ACE Lens on Data Generation for LLM Agents；CritICL: Inference-Time Weak-to-Strong Generalization from Small Language Model Failure Modes；StreamPI: Streaming Multimodal Temporal Modeling for Vision-Language-Action Models；Giving robots a better feel for object manipulation）
- 关键词：trajectory、long-horizon、language model、reasoning、github、reinforcement learning、rl、video
...
#### 关注
- [StreamPI: Streaming Multimodal Temporal Modeling for Vision-Language-Action Models](https://arxiv.org/abs/2608.26067) （关注；具身智能 / VLA / 世界模型；个人相关度=0.83；全局热度=0.43；炒作风险=0.00）
...
- [TacForcing: Streaming Action Generation with Execution-Time Tactile Feedback](https://arxiv.org/abs/2608.25798) （关注；具身智能 / VLA / 世界模型；个人相关度=0.80；全局热度=0.46；炒作风险=0.00）
...
### 通用 Agent / 推理
- [What Makes Good Agentic Data? An ACE Lens on Data Generation for LLM Agents](https://arxiv.org/abs/2608.27260) （关注；Agent / 推理 / 推理时扩展 / 规划；个人相关度=0.83；全局热度=0.51；炒作风险=0.00）
...
### 强化学习
- [TTPO: Test-Time Policy Optimization](https://arxiv.org/abs/2608.27448) （归档；RL；个人相关度=0.65；全局热度=0.49；炒作风险=0.00）
...
##### 1. [CaSKG: Counterfactual-Causal Skill Graphs for Scalable Agent Skill Retrieval](https://arxiv.org/abs/2608.25500)
- 阅读层级：关注
...
##### 2. [PAWBench: How Far Are We from Probabilistically Aligned World Modeling?](https://arxiv.org/abs/2608.27345)
- 阅读层级：关注
- 来源：Hugging Face Daily Papers
- 证据来源：仅摘要
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
##### 5. [WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution](https://arxiv.org/abs/2608.27454)
- 阅读层级：归档
- 来源：Hugging Face Daily Papers
- 证据来源：仅摘要
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
### Other Benchmarks
- 其余 7 个只进入附录标题列表：reports/appendix/2026-08-30-benchmarks.md
...
- 发布时间：2026-08-30T00:15:32+00:00
- 主方向：GitHub / 开源项目推荐
...
- 阅读优先级：克隆运行
- 来源：GitHub AI Research Projects（聚合来源；角色=代码可操作性来源）
- 发布时间：2026-08-29T15:50:46+00:00
- 主方向：GitHub / 开源项目推荐
...
- 阅读优先级：克隆运行
- 来源：GitHub AI Research Projects（聚合来源；角色=代码可操作性来源）
- 发布时间：2026-08-22T04:01:54+00:00
- 主方向：GitHub / 开源项目推荐
...
- 生成时间：2026-08-30T00:39:33.261810+00:00
- 来源数量：28
- 原始条目数：433
- 去重后条目数：374
- API 请求总数：5
...
- 缓存命中：0
- 缓存未命中：4
- Benchmark 附录：reports/appendix/2026-08-30-benchmarks.md

- 报告路径：reports/daily/2026/08/2026-08-30.md
- 上一份报告链接：reports/daily/2026/08/2026-08-29.md
