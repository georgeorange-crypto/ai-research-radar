...
- [Morphing into Hybrid Attention Models](https://arxiv.org/abs/2606.30562)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.78，global 0.45）
...
- [Denser neq Better: Limits of On-Policy Self-Distillation for Continual Post-Training](https://arxiv.org/abs/2607.01763)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.86，global 0.48）
...
#### Watch
- [DuoMem: Towards Capable On-Device Memory Agents via Dual-Space Distillation](https://arxiv.org/abs/2606.29961)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.87，global 0.44）
...
### RL
- [Breaking Failure Cascades: Step-Aware Reinforcement Learning for Medical Multimodal Reasoning](https://arxiv.org/abs/2606.31825)（WATCH，RL，证据 abstract only，personal 0.78，global 0.44）
...
Other Watch / Archive：
- [Embodied.cpp: A Portable Inference Runtime of Embodied AI Models on Heterogeneous Robots](https://arxiv.org/abs/2607.02501v1)（WATCH，Other Highlights，证据 abstract only，personal 0.76，global 0.39）
...
##### 2. [EvoPolicyGym: Evaluating Autonomous Policy Evolution in Interactive Environments](https://arxiv.org/abs/2607.02440v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 4. [AGVBench: A Reliability-Oriented Benchmark of Data Augmentation for Vein Recognition](https://arxiv.org/abs/2607.02271v1)
- 阅读层级：ARCHIVE
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估摘要中描述的任务能力；具体指标需打开原文确认。
...
### Other Benchmarks
- 其余 12 个只进入附录标题列表：reports/appendix/2026-07-07-benchmarks.md
...
- 发布时间：2026-07-06T23:38:06+00:00
...
- 发布时间：2026-07-06T20:32:10+00:00
...
- [PACE: A Proxy for Agentic Capability Evaluation](https://arxiv.org/abs/2607.02032)
  ...
  - 类型：paper
  - 为什么值得关注：institution_signal 0.96，authority_score 0.96
  - 与我的研究方向关系：Benchmark / Dataset / Evaluation，personal 0.87
  - 建议行动：watch
...
## 12. Collection Notes
- Generated at: 2026-07-06T23:41:28.245305+00:00
- Source count: 30
- Raw item count: 558
- Dedup item count: 483
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: kimi
- reason: unauthorized
- Benchmark appendix: reports/appendix/2026-07-07-benchmarks.md

- Report path: reports/daily/2026/07/2026-07-07.md
- Previous report link: reports/daily/2026/07/2026-07-06.md
