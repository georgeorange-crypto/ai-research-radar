...
- Skim count: 8 (Whole-Body Conditioned Egocentric Video Prediction；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；RL without TD learning；AgentRefine: Enhancing Agent Generalization through Refinement Tuning；CombiMOTS: Combinatorial Multi-Objective Tree Search for Dual-Target Molecule Generation)
...
- Keywords: framework、environment、berkeley.edu、evaluation、diffusion、attention、inference、planning
...
- [GitHub's plan for Agents — Kyle Daigle, GitHub](https://www.latent.space/p/github)（ARCHIVE，Agent / Reasoning / Inference-time Scaling / Planning，证据 full text，personal 0.59，global 0.33）
...
- [OpenAI's Frontier Governance Framework](https://openai.com/index/openai-frontier-governance-framework)（ARCHIVE，Other Highlights，证据 full text，personal 0.51，global 0.45）
...
- [A shared playbook for trustworthy third party evaluations](https://openai.com/index/trustworthy-third-party-evaluations-foundations)（ARCHIVE，Other Highlights，证据 full text，personal 0.48，global 0.44）
- [Extending Human Intelligence Through AI](https://www.microsoft.com/en-us/research/blog/extending-human-intelligence-through-ai/)（ARCHIVE，Other Highlights，证据 full text，personal 0.48，global 0.45）
- [Private analytics via zero-trust aggregation](https://research.google/blog/private-analytics-via-zero-trust-aggregation/)（ARCHIVE，Other Highlights，证据 full text，personal 0.47，global 0.45）
...
### Other Benchmarks
- 其余 10 个只进入附录标题列表：reports/appendix/2026-06-03-benchmarks.md
...
- 发布时间：2026-06-02T21:49:40+00:00
...
- 发布时间：2026-06-03T00:11:15+00:00
...
## 12. Collection Notes
- Generated at: 2026-06-03T00:15:26.011533+00:00
- Source count: 26
- Raw item count: 458
- Dedup item count: 400
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: none
- reason: none
- Benchmark appendix: reports/appendix/2026-06-03-benchmarks.md

- Report path: reports/daily/2026/06/2026-06-03.md
- Previous report link: reports/daily/2026/06/2026-06-02.md

## Source Health
- Hugging Face Daily Papers: error (0 items) - 429 Client Error: Too Many Requests for url: https://huggingface.co/api/daily_papers
- arXiv AI/ML/NLP/Vision/Robotics: error (0 items) - 429 Client Error: Too Many Requests for url: https://export.arxiv.org/api/query?search_query=cat%3Acs.AI+OR+cat%3Acs.LG+OR+cat%3Acs.CL+OR+cat%3Acs.CV+OR+cat%3Acs.RO+OR+cat%3Astat.ML&sortBy=submittedDa
