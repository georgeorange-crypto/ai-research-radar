...
- Must Read count: 3 (Fast-dDrive: Efficient Block-Diffusion VLM for Autonomous Driving；Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection)
- Skim count: 8 (Whole-Body Conditioned Egocentric Video Prediction；Don't Guess, Just Ask: Resolving Ambiguity in Referring Segmentation via Multi-turn Clarification；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；RL without TD learning；AgentFugue: Agent Scaling for Long-Horizon Tasks through Collective Reasoning)
- Watch count: 12 (ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；Advancing Creative Physical Intelligence in Large Multimodal Models；Q-RAG: Long Context Multi‑Step Retrieval via Value‑Based Embedder Training；Identifying Interactions at Scale for LLMs；MemTrace: Tracing and Attributing Errors in Large Language Model Memory Systems)
- Keywords: framework、planning、berkeley.edu、evaluation、environment、diffusion、inference、long-horizon
...
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2605.23163
- 发布时间：2026-05-24T20:00:00+00:00
- 这是什么？Fast-dDrive: Efficient Block-Diffusion VLM for Autonomous Driving：研究论文，方向为“Context Compression / Long Context / Memory”；主要线索：KV cache、KV-cache、cache reuse、diffusion。
- 解决了什么问题？它关注“Context Compression / Long Context / Memory”里的 KV cache、KV-cache、cache reuse、diffusion 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 KV cache、KV-cache、cache reuse、diffusion；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=MUST_READ editorial_priority=0.90 今天安排深读。 personal=0.93，relevance=0.96。
- 是否建议深读？建议今天深读。
- 建议行动：read_pdf
- 评分：global_score 0.48；personal_score 0.93；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.23；actionability 0.57；research_relevance 0.96；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：上下文压缩 / 长上下文 / 记忆
- 相关标签：Agent / Reasoning / Inference-time Scaling / Planning、Model Distillation / Model Compression / Efficient Training、CV、Benchmark / Dataset / Evaluation
- 命中关键词：KV cache、KV-cache、cache reuse、diffusion、efficient inference、framework、inference、planning、safety、sota
...
- [MemTrace: Tracing and Attributing Errors in Large Language Model Memory Systems](https://arxiv.org/abs/2605.28732)（WATCH，Context Compression / Long Context / Memory，证据 abstract only，personal 0.92，global 0.54）
...
##### 2. [Don't Guess, Just Ask: Resolving Ambiguity in Referring Segmentation via Multi-turn Clarification](https://arxiv.org/abs/2605.17531)
- 阅读层级：SKIM
- 来源：Hugging Face Daily Papers
- 来源类型：聚合/摘要
- source_role：paper_source
...
- 发布时间：2026-05-23T20:00:00+00:00
- 这是什么？Don't Guess, Just Ask: Resolving Ambiguity in Referring Segmentation via Multi-turn Clarification：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：agentic、dialogue、framework、github。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 agentic、dialogue、framework、github 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 agentic、dialogue、framework、github；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.87 今天快速扫读。 personal=0.97，relevance=0.96。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.47；personal_score 0.97；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.12；actionability 0.78；research_relevance 0.96；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：CV、Benchmark / Dataset / Evaluation、GitHub / Open Source Projects、RL
- 命中关键词：agentic、benchmark、dialogue、evaluation、framework、github、grpo、optimization、reasoning、segmentation
...
- [Advancing Creative Physical Intelligence in Large Multimodal Models](https://arxiv.org/abs/2605.26396)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.95，global 0.47）
- [Masked Skill Token Training for Hierarchical Off-Dynamics Transfer](https://openreview.net/forum?id=K4ngUOra9m)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.92，global 0.30）
...
- [GradSentry: Gradient Spectral Entropy for Backdoor Sample Filtering in Large Language Model Fine-Tuning](https://arxiv.org/abs/2605.26574)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.76，global 0.48）
...
- [OSP-Next: Efficient High-Quality Video Generation with Sparse Sequence Parallelism, HiF8 Quantization, and Reinforcement Learning](https://arxiv.org/abs/2605.28691)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.72，global 0.42）
...
### RL
- [Long Live The Balance: Information Bottleneck Driven Tree-based Policy Optimization](https://arxiv.org/abs/2605.28109)（WATCH，RL，证据 abstract only，personal 0.83，global 0.52）
- [Guiding LLM Post-training Data Engineering with Model Internals from Sparse Autoencoders](https://arxiv.org/abs/2605.27354)（ARCHIVE，RL，证据 abstract only，personal 0.73，global 0.48）
...
- [Contrastive Distribution Matching for Amortized Sequential Monte Carlo in Discrete Diffusion](https://arxiv.org/abs/2605.23346)（ARCHIVE，Other Highlights，证据 abstract only，personal 0.63，global 0.40）
...
- [Warp's big bet on building open source with GPT-5.5](https://openai.com/index/warp)（ARCHIVE，Other Highlights，证据 full text，personal 0.52，global 0.48）
- [OpenAI's Frontier Governance Framework](https://openai.com/index/openai-frontier-governance-framework)（ARCHIVE，Other Highlights，证据 full text，personal 0.52，global 0.51）
...
##### 3. [Got a Secret? LLM Agents Can't Keep It: Evaluating Privacy in Multi-Agent Systems](https://arxiv.org/abs/2605.27766)
- 阅读层级：WATCH
- 来源：Hugging Face Daily Papers
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 4. [AgentHijack: Benchmarking Computer Use Agent Robustness to Common Environment Corruptions](https://arxiv.org/abs/2605.25707)
- 阅读层级：WATCH
- 来源：Hugging Face Daily Papers
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
### Other Benchmarks
- 其余 11 个只进入附录标题列表：reports/appendix/2026-05-29-benchmarks.md
...
- 发布时间：2026-05-28T23:49:21+00:00
...
- [GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection](https://arxiv.org/abs/2605.28534)
  ...
  - 建议行动：read_pdf
- [Don't Guess, Just Ask: Resolving Ambiguity in Referring Segmentation via Multi-turn Clarification](https://arxiv.org/abs/2605.17531)
  - 学校 / 实验室：Hugging Face
  - 类型：paper
  - 为什么值得关注：institution_signal 0.96，authority_score 0.96
  - 与我的研究方向关系：Agent / Reasoning / Inference-time Scaling / Planning，personal 0.97
...
- 今日新论文继承了什么问题：Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection；Fast-dDrive: Efficient Block-Diffusion VLM for Autonomous Driving 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
...
- 相关今日条目：
  ...
  - [GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection](https://arxiv.org/abs/2605.28534)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、planning）
  - [Fast-dDrive: Efficient Block-Diffusion VLM for Autonomous Driving](https://arxiv.org/abs/2605.23163)（Context Compression / Long Context / Memory；连接词：planning）
...
## 11. Deep Read List
- [Fast-dDrive: Efficient Block-Diffusion VLM for Autonomous Driving](https://arxiv.org/abs/2605.23163)：预计阅读目的：判断其长上下文、记忆或压缩机制是否能迁移到你的研究主线。
...
- [GUI-CIDER: Mid-training GUI Agents via Causal Internalization and Density-aware Exemplar Reselection](https://arxiv.org/abs/2605.28534)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-05-28T23:53:45.390817+00:00
- Source count: 30
- Raw item count: 553
- Dedup item count: 504
- Summary mode: single
- Provider: kimi
- Model: moonshot-v1-8k
...
- provider_disabled: kimi
- reason: unauthorized
- Benchmark appendix: reports/appendix/2026-05-29-benchmarks.md

- Report path: reports/daily/2026/05/2026-05-29.md
- Previous report link: reports/daily/2026/05/2026-05-28.md
...
- ICCV: error (0 items) - 500 Server Error: Internal Server Error for url: https://iccv.thecvf.com/
