...
- Must Read count: 3 (Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；Proposal-Conditioned Latent Diffusion for Closed-Loop Traffic Scenario Generation；OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning)
- Skim count: 8 (E-TTS: A New Embodied Test-Time Scaling Framework for Robotic Manipulation；Confidence-Aware Tool Orchestration for Robust Video Understanding；PhysiFormer: Learning to Simulate Mechanics in World Space；Advancing Omnimodal Embodied Agents from Isolated Skills to Everyday Physical Autonomy；Information-Aware KV Cache Compression for Long Reasoning)
...
- Keywords: framework、nlp、robotics、cs.RO、trajectory、reasoning、agentic、attention
...
- 为什么对我重要？tier=SKIM editorial_priority=0.88 今天快速扫读。 personal=0.85，relevance=0.80。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.49；personal_score 0.85；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.14；actionability 0.56；research_relevance 0.80；hype_risk 0.00
...
#### Skim
##### 1. [E-TTS: A New Embodied Test-Time Scaling Framework for Robotic Manipulation](https://arxiv.org/abs/2606.27268v1)
- 阅读层级：SKIM
...
- 为什么对我重要？tier=SKIM editorial_priority=0.93 今天快速扫读。 personal=0.94，relevance=0.94。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
...
##### 2. [Confidence-Aware Tool Orchestration for Robust Video Understanding](https://arxiv.org/abs/2606.26904)
- 阅读层级：SKIM
- 来源：Hugging Face Daily Papers
- 来源类型：聚合/摘要
- source_role：paper_source
- 证据来源：abstract only
- 原文链接：https://arxiv.org/abs/2606.26904
- 发布时间：2026-06-24T20:00:00+00:00
- 这是什么？Confidence-Aware Tool Orchestration for Robust Video Understanding：研究论文，方向为“Agent / Reasoning / Inference-time Scaling / Planning”；主要线索：agentic、framework、grpo、language model。
- 解决了什么问题？它关注“Agent / Reasoning / Inference-time Scaling / Planning”里的 agentic、framework、grpo、language model 等问题。
- 方法或贡献是什么？摘要可确认它提出或引入了 agentic、framework、grpo、language model；具体训练设置、指标和消融细节需读原文确认。
- 为什么对我重要？tier=SKIM editorial_priority=0.89 今天快速扫读。 personal=0.94，relevance=0.94。
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：skim
- 评分：global_score 0.51；personal_score 0.94；credibility 0.87；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.19；actionability 0.65；research_relevance 0.94；hype_risk 0.00
- 多源信号：论文:Hugging Face Daily Papers
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
- 命中方向：Agent / Reasoning / Inference-time Scaling / Planning
- 相关标签：CV、GitHub / Open Source Projects、RL、NLP
- 命中关键词：agentic、framework、grpo、language model、open-source、reasoning、trajectory、video、visual

#### Watch
- [OpenRCA 2.0: From Outcome Labels to Causal Process Supervision](https://arxiv.org/abs/2606.27154v1)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.99，global 0.40）
...
- [OpenBioRQ: Unsolved Biomedical Research Questions for Agents](https://arxiv.org/abs/2606.21959)（ARCHIVE，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.67，global 0.40）
...
#### Watch
- [Data-Free Reservoir Features for Efficient Long-Horizon Cold-Start Continual Learning](https://arxiv.org/abs/2606.27095v1)（WATCH，Novel Class Discovery / Open-World Learning / OOD / Continual Learning，证据 abstract only，personal 0.84，global 0.38）
...
- [DanceOPD: On-Policy Generative Field Distillation](https://arxiv.org/abs/2606.27377v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.78，global 0.39）
...
### CV
- [Ask, Solve, Generate: Self-Evolving Unified Multimodal Understanding and Generation via Self-Consistency Rewards](https://arxiv.org/abs/2606.27376v1)（WATCH，CV，证据 abstract only，personal 0.81，global 0.39）
- [Pseudo-Text-Conditioned 3D Grounding DINO for Organ Localization in Abdominal CT](https://arxiv.org/abs/2606.27084v1)（WATCH，CV，证据 abstract only，personal 0.80，global 0.38）

### NLP
- [The Geometry of Updates: Fisher Alignment at Vocabulary Scale](https://arxiv.org/abs/2606.27242v1)（WATCH，NLP，证据 abstract only，personal 0.71，global 0.38）
- [Mapping Political-Elite Networks in Europe with a Multilingual Joint Entity-Relation Extraction Pipeline](https://arxiv.org/abs/2606.27347v1)（WATCH，NLP，证据 abstract only，personal 0.70，global 0.38）

### RL
- [Designing Reward Signals for Portable Query Generation: A Case Study in Industrial Semantic Job Search](https://arxiv.org/abs/2606.27291v1)（WATCH，RL，证据 abstract only，personal 0.82，global 0.39）
- [Improving General Role-Playing Agents via Psychology-Grounded Reasoning and Role-Aware Policy Optimization](https://arxiv.org/abs/2606.27025v1)（WATCH，RL，证据 abstract only，personal 0.78，global 0.38）

### Model Architecture
- [SubdivAR: Autoregressive Next-Scale Prediction for Neural Mesh Subdivision](https://arxiv.org/abs/2606.27088v1)（WATCH，Model Architecture，证据 abstract only，personal 0.65，global 0.39）
...
### Learning Methods
- [Stochastic Gradient Optimization with Model-Assisted Sampling](https://arxiv.org/abs/2606.27171v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.79，global 0.40）
- [DMuon: Efficient Distributed Muon Training with Near-Adam Overhead](https://arxiv.org/abs/2606.27153v1)（WATCH，Learning Methods / Optimization / Representation Learning，证据 abstract only，personal 0.73，global 0.39）
...
- [Learning to Fold: prizewinning solution at LeHome Challenge 2026 (1st place online, 2nd offline)](https://arxiv.org/abs/2606.27163v1)（WATCH，Other Highlights，证据 abstract only，personal 0.70，global 0.50）
- [Autoregressive Boltzmann Generators](https://arxiv.org/abs/2606.27361v1)（WATCH，Other Highlights，证据 abstract only，personal 0.67，global 0.40）
- [LA4VLA: Learning to Act without Seeing via Language-Action Pretraining](https://arxiv.org/abs/2606.27295v1)（WATCH，Other Highlights，证据 abstract only，personal 0.66，global 0.39）
- [Graph Neural Networks Applications Across Domains: All Insights You Need](https://arxiv.org/abs/2606.27202v1)（WATCH，Other Highlights，证据 abstract only，personal 0.66，global 0.39）
- [PAMAE: Phase-Aware-MoE Action Experts Towards Reliable Flow-Matching Vision-Language-Action Policies](https://arxiv.org/abs/2606.27144v1)（WATCH，Other Highlights，证据 abstract only，personal 0.65，global 0.38）
- [VibeAct: Vibration to Actions for Contact-Rich Reactive Robot Dexterity](https://arxiv.org/abs/2606.27344v1)（WATCH，Other Highlights，证据 abstract only，personal 0.64，global 0.39）
...
### Other Benchmarks
- 其余 12 个只进入附录标题列表：reports/appendix/2026-06-27-benchmarks.md
...
- 发布时间：2026-06-26T23:38:32+00:00
...
- 发布时间：2026-06-26T23:37:25+00:00
...
- 今日新论文继承了什么问题：Adaptive Parallel Reasoning: The Next Paradigm in Efficient Inference Scaling；OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning；Proposal-Conditioned Latent Diffusion for Closed-Loop Traffic Scenario Generation 继承了经典 agent 论文中的问题：如何把推理、行动、工具调用和环境反馈组织成可检查的轨迹。
...
- 相关今日条目：
  ...
  - [OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning](https://arxiv.org/abs/2606.26790)（Agent / Reasoning / Inference-time Scaling / Planning；连接词：agents、search）
...
- [OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning](https://arxiv.org/abs/2606.26790)：预计阅读目的：提取 Agent 任务设定、工具使用方式、规划机制和评测指标。

## 12. Collection Notes
- Generated at: 2026-06-26T23:47:08.385659+00:00
- Source count: 31
- Raw item count: 676
...
- provider_disabled: none
- reason: none
- Benchmark appendix: reports/appendix/2026-06-27-benchmarks.md

- Report path: reports/daily/2026/06/2026-06-27.md
- Previous report link: reports/daily/2026/06/2026-06-26.md
