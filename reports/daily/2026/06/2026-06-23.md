...
- Skim count: 8 (Whole-Body Conditioned Egocentric Video Prediction；Scaling Up Reinforcement Learning for Traffic Smoothing: A 100-AV Highway Deployment；Gradient-based Planning for World Models at Longer Horizons；SoftSkill: Behavioral Compression for Contextual Adaptation；Autonomous Driving with Priority-Ordered STL Specifications Under Multimodal Uncertainty)
- Watch count: 12 (ShieldAgent: Shielding Agents via Verifiable Safety Policy Reasoning；RL without TD learning；Q-RAG: Long Context Multi‑Step Retrieval via Value‑Based Embedder Training；Identifying Interactions at Scale for LLMs；Context-Aware RL for Agentic and Multimodal LLMs)
- Keywords: nlp、robotics、framework、attention、berkeley.edu、evaluation、inference、long-horizon
...
- [Context-Aware RL for Agentic and Multimodal LLMs](https://arxiv.org/abs/2606.17053)（WATCH，Agent / Reasoning / Inference-time Scaling / Planning，证据 abstract only，personal 0.92，global 0.43）
...
- [Robust $Q$-learning for mean-field control under Wasserstein uncertainty in common noise](https://arxiv.org/abs/2606.20356v1)（WATCH，Model Distillation / Model Compression / Efficient Training，证据 abstract only，personal 0.73，global 0.34）
...
- [PerceptionDLM: Parallel Region Perception with Multimodal Diffusion Language Models](https://arxiv.org/abs/2606.19534)（WATCH，CV，证据 abstract only，personal 0.79，global 0.51）
...
##### 3. [Contagion Networks: Evaluator Bias Propagation in Multi-Agent LLM Systems](https://arxiv.org/abs/2606.20493v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
##### 4. [StylisticBias: A Few Human Visual Cues Drive Most Social Biases in MLLMs](https://arxiv.org/abs/2606.20527v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
...
##### 5. [LLM agent safety, multi-turn red-teaming, jailbreak benchmarks, adversarial robustness, safety-critical systems](https://arxiv.org/abs/2606.20408v1)
- 阅读层级：WATCH
- 来源：arXiv AI/ML/NLP/Vision/Robotics
- 证据来源：abstract only
- benchmark 评估什么能力：评估 agent 规划、执行或环境交互能力。
...
### Other Benchmarks
- 其余 13 个只进入附录标题列表：reports/appendix/2026-06-23-benchmarks.md
...
- 发布时间：2026-06-22T23:45:17+00:00
...
- 是否建议深读？今天不深读，先按行动建议处理。
- 建议行动：save
- 评分：global_score 0.58；personal_score 0.73；credibility 0.86；conference 0.00；institution 0.96；multi_source 0.00；community_signal 0.69；actionability 1.00；research_relevance 0.63；hype_risk 0.00
- 多源信号：代码:GitHub AI Research Projects
- 推荐解释：尚未生成结构化解释
- 风险提示：none
- 来源级别：unknown
...
## 12. Collection Notes
- Generated at: 2026-06-22T23:54:02.625410+00:00
- Source count: 31
- Raw item count: 678
...
- provider_disabled: kimi
- reason: unauthorized
- Benchmark appendix: reports/appendix/2026-06-23-benchmarks.md

- Report path: reports/daily/2026/06/2026-06-23.md
- Previous report link: reports/daily/2026/06/2026-06-22.md
