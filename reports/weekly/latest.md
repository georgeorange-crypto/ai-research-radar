...
- Institutional Updates：84 条进入跟踪；高频信号：cmu.edu、stanford.edu、anthropic.com、deepmind.google、nvidia.com、openai.com。
...
- Other Highlights：56 条进入跟踪；高频信号：robotics、nlp、systems、cs.LG、privacy、safety。
...
- Learning Methods / Optimization / Representation Learning：47 条进入跟踪；高频信号：nlp、cs.LG、robotics、optimization、framework、gradient。
...
- NLP：44 条进入跟踪；高频信号：language model、nlp、cs.CL、framework、robotics、princeton。
...
- GitHub / Open Source Projects：34 条进入跟踪；高频信号：github、open-source、framework、github.com、detection、evaluation。
...
- Context Compression / Long Context / Memory：26 条进入跟踪；高频信号：github、github.com、open-source、RAG、nlp、long-context。
...
- Novel Class Discovery / Open-World Learning / OOD / Continual Learning：20 条进入跟踪；高频信号：github、clustering、generalization、nlp、out-of-distribution、framework。
...
## 下周跟踪建议
- 继续跟踪 LLM Agents / Tool Use / Planning / Multi-Agent：本周最强信号是 [Instrumental Choices: Measuring the Propensity of LLM Agents to Pursue Instrumental Behaviors](https://arxiv.org/abs/2605.06490v1)。
- 继续跟踪 Institutional Updates：本周最强信号是 [Parloa builds service agents customers want to talk to](https://openai.com/index/parloa)。
- 继续跟踪 Other Highlights：本周最强信号是 [CLAD: A Clustered Label-Agnostic Federated Learning Framework for Joint Anomaly Detection and Attack Classification](https://arxiv.org/abs/2605.06571v1)。
- 继续跟踪 CV：本周最强信号是 [DINORANKCLIP: DINOv3 Distillation and Injection for Vision-Language Pretraining with High-Order Ranking Consistency](https://arxiv.org/abs/2605.06592v1)。
