...
- 纳入日报：4 份
- 跟踪条目：923；MUST_READ 7；SKIM 22；ARCHIVE 250
...
- [LongHorizon-Harness: Advancing Long-Horizon Agents for Real-World Tasks](https://arxiv.org/abs/2608.01964)（SKIM，Agent / Reasoning / Inference-time Scaling / Planning，personal 0.85，global 0.55）
- [FedCritic-MIMO: Communication-Efficient Serverless Federated Critic Learning for Massive-MIMO Resource Control in Open and Disaggregated 6G RANs](https://arxiv.org/abs/2608.03852v1)（SKIM，Compression / Reliability for AI Infrastructure，personal 0.85，global 0.49）
- [MAFIA: Query-Only Memory Attacks via Probing and Factual Injection against Audited LLM Agents](https://arxiv.org/abs/2608.03844v1)（SKIM，Agent / Reasoning / Inference-time Scaling / Planning，personal 0.84，global 0.40）

## 分方向趋势
- AI Systems / HPC / Distributed Training & Inference：258 条进入跟踪；高频信号：HPC、data path、systems、cs.LG、cs.DC、framework。
...
- Embodied Intelligence / VLA / World Models：229 条进入跟踪；高频信号：nlp、robotics、framework、cs.CV、cs.AI、image。
...
- Agent / Reasoning / Inference-time Scaling / Planning：90 条进入跟踪；高频信号：reasoning、agent、framework、language model、agentic、nlp。
...
- Benchmark / Dataset / Evaluation：78 条进入跟踪；高频信号：benchmark、evaluation、nlp、language model、robotics、cs.AI。
...
- Institutional Updates：51 条进入跟踪；高频信号：anthropic.com、openai.com、deepmind.google、microsoft.com、research.google、nvidia.com。
...
- NLP：31 条进入跟踪；高频信号：nlp、cs.CL、robotics、language model、princeton、systems。
...
- CV：22 条进入跟踪；高频信号：image、video、diffusion、language model、multimodal、framework。
...
- Compression / Reliability for AI Infrastructure：18 条进入跟踪；高频信号：nlp、cs.LG、robotics、compression、cs.NI、framework。
...
- Model Distillation / Model Compression / Efficient Training：13 条进入跟踪；高频信号：distillation、inference、framework、github、language model、quantization。
...
- Agent Runtime / RL Infrastructure / Scheduling：12 条进入跟踪；高频信号：agent、cs.AI、nlp、robotics、detection、runtime。
...
- Learning Methods / Optimization / Representation Learning：5 条进入跟踪；高频信号：optimization、attention、gradient、github、benchmark、berkeley.edu。
