...
- 纳入日报：3 份
- 跟踪条目：735；MUST_READ 4；SKIM 16；ARCHIVE 229
...
## 分方向趋势
- AI Systems / HPC / Distributed Training & Inference：205 条进入跟踪；高频信号：HPC、data path、systems、cs.LG、cs.DC、framework。
...
- Embodied Intelligence / VLA / World Models：165 条进入跟踪；高频信号：nlp、robotics、framework、cs.CV、cs.AI、cs.RO。
...
- Agent / Reasoning / Inference-time Scaling / Planning：71 条进入跟踪；高频信号：reasoning、agent、agentic、framework、language model、long-horizon。
...
- Benchmark / Dataset / Evaluation：51 条进入跟踪；高频信号：benchmark、evaluation、nlp、language model、robotics、cs.AI。
...
- CV：17 条进入跟踪；高频信号：image、language model、video、inference、multimodal、diffusion。
...
- Context Compression / Long Context / Memory：10 条进入跟踪；高频信号：agent、agent memory、long-context、llm agent、nlp、attention。
...
- Agent Runtime / RL Infrastructure / Scheduling：10 条进入跟踪；高频信号：agent、cs.AI、nlp、robotics、framework、runtime。
