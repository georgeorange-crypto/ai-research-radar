...
- Must Read count: 0
- Skim count: 8 (GRAIN: Bridging Name and Narrative Shifts in Real-World Graph Reasoning through Invariance-Rewarded Agentic RL; RedEvoAgent: Automatic Red-Teaming Agent with Experience-Driven Skill Evolution; INTENT-AS-A-TOOL Makes it Easy to Track Agentic Misalignment; The Handoff Tax: Continuing Non-Native Trajectories in LLM Agents; Agentic Game Development as a Verifiable Trajectory Data Engine for Scaling World Models)
- Watch count: 12 (When Text Misleads: Inconsistent-Aware Reasoning for Audio-Grounded Dialogue; Securing the AI Agent: A Unified Framework for Multi-Layer Agent Red Teaming; Verify Smarter, Evolve Further: Efficient Harness Evolution through Behavior-Aware Verification; PACE: A Unified Condense-and-Extract Paradigm for Fast VLM Inference; TADP: Task-Aware Deformable Prediction for Single-Stage 3D Object Detection)
- Keywords: nlp, agentic, language model, robotics, agent, cs.AI, trajectory, rl
...
- [Scaling Graph Neural Networks for Friend Recommendation: Multi-Hash User Embeddings and Temporal Neighbor Sampling](https://arxiv.org/abs/2608.27413v1) （关注；AI 系统 / HPC / 分布式训练与推理；个人相关度=0.83；全局热度=0.40；炒作风险=0.00）
- [Puro-2B: Poor Lab's Qwen2-1.5B Trained on RTX 5090 within $5090](https://arxiv.org/abs/2608.27370v1) （关注；AI 系统 / HPC / 分布式训练与推理；个人相关度=0.83；全局热度=0.52；炒作风险=0.00）
...
#### Watch
- [TRACE-CRC: Trajectory-Adaptive Conformal Risk Control for Multi-Step Channel State Information Prediction](https://arxiv.org/abs/2608.27124v1) （关注；AI 基础设施压缩 / 可靠性；个人相关度=0.81；全局热度=0.37；炒作风险=0.00）
- [TwinKV: A Composable Repair Pass for KV Cache Eviction via Pairwise Key Redundancy](https://arxiv.org/abs/2608.27128v1) （关注；AI 基础设施压缩 / 可靠性；个人相关度=0.80；全局热度=0.38；炒作风险=0.00）
...
#### Watch
- [Verify Smarter, Evolve Further: Efficient Harness Evolution through Behavior-Aware Verification](https://arxiv.org/abs/2608.27311v1) （关注；Agent 运行时 / RL 基础设施 / 调度；个人相关度=0.86；全局热度=0.41；炒作风险=0.00）
- [When Tool Outputs Become Commands: Separating Action Induction from Runtime Authorization in Tool-Augmented LLM Agents](https://arxiv.org/abs/2608.27146v1) （关注；Agent 运行时 / RL 基础设施 / 调度；个人相关度=0.83；全局热度=0.39；炒作风险=0.00）
- [LLMs in Digital EDA: A perspective on shifting roles from Generation to Orchestration](https://arxiv.org/abs/2608.27184v1) （关注；Agent 运行时 / RL 基础设施 / 调度；个人相关度=0.77；全局热度=0.40；炒作风险=0.00）
...
#### Watch
- [When Text Misleads: Inconsistent-Aware Reasoning for Audio-Grounded Dialogue](https://arxiv.org/abs/2608.27176v1) （关注；具身智能 / VLA / 世界模型；个人相关度=0.86；全局热度=0.50；炒作风险=0.00）
- [PACE: A Unified Condense-and-Extract Paradigm for Fast VLM Inference](https://arxiv.org/abs/2608.27206v1) （关注；具身智能 / VLA / 世界模型；个人相关度=0.85；全局热度=0.40；炒作风险=0.00）
- [TADP: Task-Aware Deformable Prediction for Single-Stage 3D Object Detection](https://arxiv.org/abs/2608.27282v1) （关注；具身智能 / VLA / 世界模型；个人相关度=0.84；全局热度=0.40；炒作风险=0.00）
...
- [What Makes Good Agentic Data? An ACE Lens on Data Generation for LLM Agents](https://arxiv.org/abs/2608.27260v1) （关注；Agent / 推理 / 推理时扩展 / 规划；个人相关度=0.83；全局热度=0.42；炒作风险=0.00）
- [CritICL: Inference-Time Weak-to-Strong Generalization from Small Language Model Failure Modes](https://arxiv.org/abs/2608.27455v1) （关注；Agent / 推理 / 推理时扩展 / 规划；个人相关度=0.83；全局热度=0.41；炒作风险=0.00）
- [Thinking on Shots: Consistent Multi-Shot Video Editing with Agentic Reasoning](https://arxiv.org/abs/2608.26809) （关注；Agent / 推理 / 推理时扩展 / 规划；个人相关度=0.82；全局热度=0.52；炒作风险=0.00）

### Reinforcement Learning
- [TTPO: Test-Time Policy Optimization](https://arxiv.org/abs/2608.27448v1) （关注；RL；个人相关度=0.65；全局热度=0.40；炒作风险=0.00）
...
### Multimodal / VLM / CV
- [CaRGo-T: Causal Reasoning Graph-of-Thought improves Multimodal Humor Comprehension](https://arxiv.org/abs/2608.23172) （关注；CV；个人相关度=0.69；全局热度=0.48；炒作风险=0.00）
...
### NLP
- [STAR : Sentence Translation Alignment Rate for Document-to-Document Machine Translation](https://arxiv.org/abs/2608.27161v1) （关注；NLP；个人相关度=0.65；全局热度=0.38；炒作风险=0.00）
- [Consolidating RLVR Capabilities Across Domains: A Deep Dive into Fusion Paradigms](https://arxiv.org/abs/2608.27409v1) （关注；NLP；个人相关度=0.63；全局热度=0.39；炒作风险=0.00）

### Open-World / Continual Learning
- 无。

### Model Distillation
- [Knowledge Distillation Driven Semantic NOMA with GAN Refinement for 6G Robotic Vehicle Networks](https://arxiv.org/abs/2608.27198v1) （关注；模型蒸馏 / 模型压缩；个人相关度=0.80；全局热度=0.39；炒作风险=0.00）
...
### Other Benchmarks
- 其余 7 个只进入附录标题列表：reports/appendix/2026-08-29-benchmarks.md
...
- Source: GitHub AI Research Projects (aggregator; role=code_actionability)
- Published: 2026-08-29T03:48:23+00:00
- Primary track: GitHub / 开源项目推荐
...
- Reading tier: clone_and_run
- Source: GitHub AI Research Projects (aggregator; role=code_actionability)
- Published: 2026-08-29T03:07:16+00:00
- Primary track: GitHub / 开源项目推荐
...
- Generated at: 2026-08-29T03:52:02.063692+00:00
- Source count: 31
- Raw item count: 692
...
- Cache hits: 0
- Cache misses: 4
- Benchmark appendix: reports/appendix/2026-08-29-benchmarks.md

- Report path: reports/daily/2026/08/2026-08-29.md
- 上一份报告链接：reports/daily/2026/08/2026-08-28.md
